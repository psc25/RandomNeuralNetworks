...
for mi in range(len(mm)):
    ...
    for Ni in range(len(NN)):
        ...
        np.savetxt("bs_data/bs_det_err_" + str(mm[mi]) + ".csv", err[mi])
        np.savetxt("bs_data/bs_det_tms_" + str(mm[mi]) + ".csv", tms[mi])
        np.savetxt("bs_data/bs_det_evl_" + str(mm[mi]) + ".csv", evl[mi])
        np.savetxt("bs_data/bs_det_u1p_" + str(mm[mi]) + ".csv", u1p[mi])
